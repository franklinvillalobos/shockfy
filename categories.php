<?php
// categories.php — Tema claro premium, FIX duplicado de nombre al editar + FIX eliminar (AJAX JSON)
// Mantiene EXACTAMENTE endpoints/métodos/ids/names usados para crear/editar/eliminar

require 'db.php';
require 'auth.php';
$user_id = $_SESSION['user_id'];

// ===== Backend intacto (crear/editar) =====
...
// ===== Eliminar (soporta AJAX JSON y navegación clásica) =====
