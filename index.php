...
<head>
  ...
  <style>
    ...
    .card {
      flex: 1 1 280px;
      min-width: 280px;
      background: linear-gradient(135deg, #4e38de, #365bef);
      color: white;
      border-radius: 25px;
      padding: 35px 30px;
      text-align: center;
    ...
    body.dark .card {
      background: linear-gradient(135deg, #4527a0, #1e88e5);
    }
    ...
    .delete-btn {
      background: linear-gradient(135deg, #e74c3c, #ff4c4c);
      color: #fff !important;
      padding: 7px 16px;
      border-radius: 12px;
      font-weight: 600;
    ...
    .sales-table tbody tr:hover td {
      background: #99c0ff !important;
    }

    /* Dark mode tablas */
    body.dark .products-table thead {
      background: #4073ffff !important;
    }

    body.dark .products-table tbody tr:nth-child(odd) td {
      background: #1b0d41ff !important;
    }

    body.dark .products-table tbody tr:nth-child(even) td {
      background: #1b0d41ff !important;
    }

    body.dark .products-table tbody tr:hover td {
      background: #1b0d41ff !important;
    }

    body.dark .sales-table thead {
      background: #c2b9b9ff !important;
    }

    body.dark .sales-table tbody tr:nth-child(odd) td {
      background: #1b0d41ff !important;
    }

    body.dark .sales-table tbody tr:nth-child(even) td {
      background: #1b0d41ff !important;
    }

    body.dark .sales-table tbody tr:hover td {
      background: #1b0d41ff !important;
    }
